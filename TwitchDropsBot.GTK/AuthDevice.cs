...
namespace TwitchDropsBot.GTK
{
    internal class AuthDevice : Dialog
    {
        ...
        public AuthDevice(SettingsManager manager, IOptionsMonitor<BotSettings> botSettings, ILogger logger) : this(new Builder("MainWindow.glade"))
        {
